...
- [ ] Add long-offline recovery beyond 24 hours, restricted/bridge guard contexts, cross-process state ownership, and path-bias integration with application circuits.
...
- [ ] Add circuit pooling/multiplexing, lifetime/expiration policy, build retry policy, and path-bias accounting.
...
- [ ] Add cross-process state locking and mature circuit reuse/expiry/retry policy.
...
ntor-v3 and newer relay cryptography, onion-service client/service support, bridges and pluggable transports, advanced congestion control, RPC, and relay/directory-authority operation are separate milestones. The initial client stages do not claim feature parity with the full Arti workspace.
